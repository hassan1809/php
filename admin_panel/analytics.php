  ...
  <div class="col">
    ...
    <div class="card card-default">
      ...
      <div class="card-body">
                                ...
                                while($row = mysqli_fetch_assoc($run)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="deleteuser.php?dit=<?php echo $row ["id"] ?>"class="btn btn-danger">delete</a>
        ...
        <a href="adduser.php"><button class ="btn btn-dark text-light d-flex m-auto" >add new user</button></a>
    </div>
